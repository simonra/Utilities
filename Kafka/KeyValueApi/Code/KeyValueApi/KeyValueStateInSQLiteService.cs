...
public class KeyValueStateInSQLiteService : IKeyValueStateService
{
    ...
    //     _logger.LogInformation($"SQLite state service process termination: In memory db connection state is {_sqliteDb.State}.");
    //     try
    //     {
    //         if(_sqliteDb.State == System.Data.ConnectionState.Open)
    //         {
    //             OverWriteDiskDbWithMemoryDb();
    //             _sqliteDb.Close();
    //         }
    ...
    //     _logger.LogInformation($"SQLite state service finalizer: In memory db connection state is {_sqliteDb.State}.");
    //     try
    //     {
    //         if(_sqliteDb.State == System.Data.ConnectionState.Open)
    //         {
